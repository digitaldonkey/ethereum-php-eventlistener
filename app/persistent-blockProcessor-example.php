...
try {
    ...
    // Persistent: Process all blocks till the last one.
    // But never redo the same even if script restarted.
    // Not a restart will set $toBlockNumber always to the latest Block.
    new BlockProcessor(
      $web3,
